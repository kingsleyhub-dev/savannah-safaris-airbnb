...
import { LayoutDashboard, FileText, Image as ImageIcon, Images, Phone, Settings, LogOut, Menu, X, ExternalLink, Users } from "lucide-react";
...
const nav = [
  ...
  { to: "/admin/dashboard/gallery", label: "Gallery Manager", icon: Images, allowedRoles: MEDIA_MANAGER_ROLES },
